  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-gradient-to-br from-white via-white to-brand-gray-light flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="mt-10 flex flex-col items-center relative z-10">
        ...
        <p className="mt-6 text-[10px] uppercase tracking-[0.5em] font-bold text-brand-dark/60">
          Cargando Experiencia
        </p>
        
        {/* Animated dots */}
        <div className="flex gap-1 mt-3">
          <span className="w-1.5 h-1.5 bg-brand-celeste rounded-full animate-bounce" style={{ animationDelay: '0ms' }} />
          <span className="w-1.5 h-1.5 bg-brand-celeste rounded-full animate-bounce" style={{ animationDelay: '150ms' }} />
          <span className="w-1.5 h-1.5 bg-brand-celeste rounded-full animate-bounce" style={{ animationDelay: '300ms' }} />
        </div>
      </div>
